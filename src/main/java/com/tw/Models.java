...
import com.tw.domain.DefaultUserRepository;
...
public class Models extends AbstractModule {
    ...
    public Models(String environment, String classPathResource, Properties properties) {
        ...
        this.properties.put("db.url", System.getenv().getOrDefault("DATABASE", "jdbc:mysql://localhost:3307/ke_tsu?user=mysql&password=mysql") + "&allowMultiQueries=true&zeroDateTimeBehavior=convertToNull");
    }
